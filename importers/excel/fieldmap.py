...
FACILITY_FORM_MAP = FormMap(
    field_maps=[
        ...
        FieldMap(
            to_field="call_sign",
            converter=None,
            from_field_aliases=["Call Sign", "Call Sign (optional)"],
        ),
        FieldMap(
        ...
        FieldMap(
            ...
            converter=coerce_num,
            from_field_aliases=["System Loss (dB)", "System Loss (dBi)"],
        ),
        FieldMap(
        ...
        FieldMap(
            ...
            converter=coerce_num,
            from_field_aliases=["Number of Quad or Octal ports with  feed power"],
        ),
        FieldMap(
        ...
        FieldMap(
            to_field="aeirp_to_gbt", converter=None, from_field_aliases=["AEiRP to GBT"]
        ),
        FieldMap(
            to_field="az_bearing",
            converter=None,
            from_field_aliases=["AZ bearing degrees True"],
        ),
        FieldMap(
            to_field="band_allowance",
            converter=None,
            from_field_aliases=["Band Allowance"],
        ),
        FieldMap(
            to_field="distance_to_first_obstacle",
            converter=None,
            from_field_aliases=["Distance to 1st obstacle (km)"],
        ),
        FieldMap(
        ...
        FieldMap(
            ...
            converter=None,
            from_field_aliases=["ERPd per # of Transmitters", "ERPd per TX"],
        ),
        FieldMap(
            to_field="height_of_first_obstacle",
            converter=None,
            from_field_aliases=["Height of 1st obstacle (ft)"],
        ),
        FieldMap(to_field="loc", converter=None, from_field_aliases=["LOC"]),
        FieldMap(
            to_field="max_aerpd", converter=None, from_field_aliases=["Max AERPd (dBm)"]
        ),
        FieldMap(
            to_field="max_erp_per_tx",
            converter=None,
            from_field_aliases=["Max ERP per TX (W)"],
        ),
        FieldMap(
            to_field="max_gain", converter=None, from_field_aliases=["Max Gain (dBi)"]
        ),
        FieldMap(
            to_field="max_tx_power",
            converter=None,
            from_field_aliases=["Max TX Pwr (W)"],
        ),
        FieldMap(
            to_field="nrao_aerpd", converter=None, from_field_aliases=["NRAO AERPd (W)"]
        ),
        FieldMap(
            to_field="power_density_limit",
            converter=None,
            from_field_aliases=["Power Density Limit"],
        ),
        FieldMap(
            to_field="sgrs_approval",
            converter=None,
            from_field_aliases=["SGRS Approval"],
        ),
        FieldMap(to_field="tap_file", converter=None, from_field_aliases=["TAP file"]),
        FieldMap(to_field="tap", converter=None, from_field_aliases=["TAP", "TPA"]),
        FieldMap(
            to_field="tx_power", converter=None, from_field_aliases=["TX Pwr (dBm)"]
        ),
    ]
)

# Generate a map of known_header->importer by "expanding" the from_field_aliases of each FieldMap
